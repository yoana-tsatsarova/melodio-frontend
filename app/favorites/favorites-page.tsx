...
import {useFavorites} from "./useFavorites";  // import the custom hook
...
const FavoritesPage = ({session}: AccountFormProps) => {
    const {songUrls, songIds, deleteSongFromPlaylist, addSongsToSpotifyPlaylist} = useFavorites(session);
    ...
    ">
                ...
                <div className={"justify-center mx-auto w-max items-center"}>
                    <div className={"flex flex-row justify-end  pt-4 pr-4"}>
                        <Button className="bg-spotify-green rounded-xl  " onClick={addSongsToSpotifyPlaylist}>Add to
                            Spotify</Button>
                    </div>
                                ...
                                <AlertDialog>
                                    ...
                                    <AlertDialogContent className={"bg-stone-900"}>
                                        ...
                                        <AlertDialogFooter>
                                            ...
                                            <AlertDialogAction className={"text-spotify-green"} onClick={() =>
                                                deleteSongFromPlaylist(songIds[songUrls?.indexOf(songUrl)])
